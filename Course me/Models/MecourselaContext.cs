...
namespace Course_me.Models
{
    public partial class MecourselaContext : DbContext
    {
        ...
        //Проблема решена, давай продолжим писать контроллеры. Следующие: Article, Diet, DietGoal, DietType, Dish, DishProduct, Exercise, ExerciseGoal, Favorite, Product, Reminder, Test, WaterIntake, Workout
